//
//  VaccumCleanersTableViewCell.swift
//  Zamroo
//
...
class VaccumCleanersTableViewCell: UITableViewCell {

    
    @IBOutlet var vaccumCleanersXibHeight: NSLayoutConstraint!
    ...
    @IBAction func selectBrandButtonTapped(_ sender: AnyObject) {
        ...
        delegate?.selectBrand(cell: self, sender: sender,brandArray: AppService.vaccuumCleanerBrandArray,isSelectBrand: true )
    }
