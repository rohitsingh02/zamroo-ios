//
//  CommercialTransportTableViewCell.swift
//  Zamroo
//
...
class CommercialTransportTableViewCell: UITableViewCell {

    @IBOutlet var commercialTransportXibHeight: NSLayoutConstraint!
    ...
    @IBAction func selectTypeButtonTapped(_ sender: AnyObject) {
        ...
        delegate?.selectBrand(cell: self, sender: sender,brandArray: AppService.commercialTransportationTypeArray,isSelectBrand: true )
    }
