...
class GeysersTableViewCell: UITableViewCell {

    @IBOutlet var geysersXibHeight: NSLayoutConstraint!
    ...
    @IBAction func selectBrandButtonTapped(_ sender: AnyObject) {
        ...
        delegate?.selectBrand(cell: self, sender: sender,brandArray: AppService.geysersBrandArray,isSelectBrand: true )
    }
