//
//  OtherBollywoodTableViewCell.swift
//  Zamroo
//
...
class OtherBollywoodTableViewCell: UITableViewCell {

    
    @IBOutlet var otherBollywoodXibHeight: NSLayoutConstraint!
    ...
    @IBAction func selectTypeTapped(_ sender: AnyObject) {
       ...
       delegate?.selectBrand(cell:self,sender: sender,brandArray : AppService.otherBollywoodPositionType,isSelectBrand : true)
    }
