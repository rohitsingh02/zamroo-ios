//
//  BusinessForSaleAndLeaseTableViewCell.swift
//  Zamroo
//
...
class BusinessForSaleAndLeaseTableViewCell: UITableViewCell {
    ...
    @IBOutlet var businessForSaleAndLeaseXibHeight: NSLayoutConstraint!
    @IBOutlet var enterPriceTextField: SkyFloatingLabelTextFieldWithIcon!
    @IBOutlet var priceAttributeLabel: UILabel!

    
    @IBOutlet var typeOfBusinessTextField: SkyFloatingLabelTextField!
    @IBOutlet var salesRevenueTextField: SkyFloatingLabelTextField!
