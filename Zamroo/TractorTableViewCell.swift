...
class TractorTableViewCell: UITableViewCell {

    @IBOutlet var tractorXibHeight: NSLayoutConstraint!
    ...
    @IBOutlet var hoursDrivenTextField: SkyFloatingLabelTextField!
    ...
    @IBAction func selectMakeButtonTapped(_ sender: AnyObject) {
        ...
        delegate?.selectBrand(cell: self, sender: sender,brandArray: AppService.tractorMakeArray,isSelectBrand: true )
    }
