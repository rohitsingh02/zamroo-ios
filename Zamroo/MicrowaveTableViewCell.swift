...
class MicrowaveTableViewCell: UITableViewCell {

    @IBOutlet var microwaveXibHeight: NSLayoutConstraint!
    ...
    @IBAction func selectBrandButtonTapped(_ sender: AnyObject) {
        ...
        delegate?.selectBrand(cell: self, sender: sender,brandArray: AppService.microwaveBrandArray,isSelectBrand: true )
    }
