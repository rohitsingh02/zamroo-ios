//
//  AccessoriesClothingTableViewCell.swift
//  Zamroo
//
...
class AccessoriesClothingTableViewCell: UITableViewCell {

    @IBOutlet var accessoriesClothingXibHeight: NSLayoutConstraint!
