//
//  WaterPurifierTableViewCell.swift
//  Zamroo
//
...
class WaterPurifierTableViewCell: UITableViewCell {

    
    @IBOutlet var waterPurifierXibHeight: NSLayoutConstraint!
    ...
    @IBAction func selectBrandButtonTapped(_ sender: AnyObject) {
        ...
        delegate?.selectBrand(cell: self, sender: sender,brandArray: AppService.waterPurifierBrandArray,isSelectBrand: true )
    }
